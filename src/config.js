...
export const veryLongVariableName = 'This is a very long string that definitely exceeds the configured printWidth limit and should be wrapped by Prettier'
